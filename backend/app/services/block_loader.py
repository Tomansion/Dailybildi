...
class BlockConfig:
    ...
    def __init__(self, block_id: str, layer: int, rarity: int, image_path: str, universe_id: str):
...
class BlockLoader:
    ...
    def load_blocks(universe_id: str) -> List[BlockConfig]:
        ...
        try:
            ...
            print(f"✅ Loaded {len(blocks)} blocks for universe '{universe_id}' from {config_path}")
            return blocks
