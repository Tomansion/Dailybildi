...
((t = void 0),
  (e = function (t) {
    var e = {
      setEventEmitter(e, i) {
        return (
          void 0 === i && (i = t.Events.EventEmitter),
          (this._privateEE = !0 === e || void 0 === e),
          (this._eventEmitter = this._privateEE ? new i() : e),
          this
        );
      },
      destroyEventEmitter() {
    ...
    const h = t.Geom.Rectangle,
      a = t.Math.Vector2,
      u = t.Math.RotateAround,
      v = t.GameObjects.Container;
    var c = void 0,
      p = function (t, e, i) {
        return (
          void 0 === e
            ? (e = new a())
            : !0 === e && (void 0 === m && (m = new a()), (e = m)),
          t.getTopLeft
            ? t.getTopLeft(e, i)
            : ((e.x = t.x - r(t) * t.originX),
              (e.y = t.y - o(t) * t.originY),
              _(t, e, i))
        );
      },
      d = function (t, e, i) {
      ...
      _ = function (t, e, i) {
        return (
          void 0 === i && (i = !1),
          0 !== t.rotation && u(e, t.x, t.y, t.rotation),
          i &&
            t.parentContainer &&
            t.parentContainer
              .getBoundsTransformMatrix()
              .transformPoint(e.x, e.y, e),
          e
        );
      },
      y = function (t, e, i, n, s) {
        if (!t) return !1;
        if (n && !n(t, e, i)) return !1;
        var r = (function (t, e) {
          if (
            (void 0 === e
              ? (e = new h())
              : !0 === e && (void 0 === c && (c = new h()), (e = c)),
            t.getBounds && !(t instanceof v))
          )
            return t.getBounds(e);
          var i, n, s, r, o, a, u, m;
          if (t.parentContainer) {
            var _ = t.parentContainer.getBoundsTransformMatrix();
            (p(t, e),
              _.transformPoint(e.x, e.y, e),
              (i = e.x),
              (n = e.y),
              d(t, e),
              _.transformPoint(e.x, e.y, e),
            ...
            (p(t, e),
              ...
              (m = e.y));
          return (
            (e.x = Math.min(i, s, o, u)),
            (e.y = Math.min(n, r, a, m)),
            (e.width = Math.max(i, s, o, u) - e.x),
            (e.height = Math.max(n, r, a, m) - e.y),
            e
          );
        })(t, !0);
        return !(!r.contains(e, i) || (s && !s(t, e, i)));
      },
      g = function (t, e, i) {
        var n = t.camera;
        return n
          ? (void 0 === i ? (i = {}) : !0 === i && (i = E),
            n === e
              ? ((i.x = t.worldX), (i.y = t.worldY))
              : n.getWorldPoint(t.x, t.y, i),
            i)
          : null;
      },
      E = {},
      x = function (t, e, i, n) {
        return (function (t, e, i, n, s) {
          var r,
            o = t.scene.sys.cameras.main,
            h = 0 === t.scrollFactorX && 0 === t.scrollFactorY;
          if (e)
            return h
              ? i(t, e.x, e.y, n, s)
              : !!(r = g(e, o, !0)) && i(t, r.x, r.y, n, s);
          for (
            var a = t.scene.input.manager,
              u = a.pointersTotal,
              v = a.pointers,
              c = 0;
            c < u;
            ...
            if (((e = v[c]), h)) {
              if (i(t, e.x, e.y, n, s)) return !0;
            } else {
              if (!(r = g(e, o, !0))) continue;
              if (i(t, r.x, r.y, n, s)) return !0;
            }
          return !1;
        })(t, e, y, i, n);
      };
    const b = t.Utils.Objects.GetValue,
      w = t.Utils.Array.SpliceOne,
      S = t.Math.Distance.Between,
      P = t.Math.Angle.Between;
    class O {
      constructor(t, e) {
        var i,
          s =
            null == (i = t) || "object" != typeof i
              ? null
              : n(i)
                ? i
                : i.scene && n(i.scene)
                  ? i.scene
                  : i.parent && i.parent.scene && n(i.parent.scene)
                    ? i.parent.scene
                    : null;
        s === t && (t = void 0);
        var r = s.input.manager.pointersTotal - 1;
        (r < 2 && s.input.addPointer(2 - r),
          (this.scene = s),
          (this.gameObject = t),
          t && t.setInteractive(b(e, "inputConfig", void 0)),
          this.setEventEmitter(b(e, "eventEmitter", void 0)),
          (this._enable = void 0),
          (this.pointers = []),
          (this.movedState = {}),
      ...
      resetFromJSON(t) {
        return (
          this.setEnable(b(t, "enable", !0)),
          (this.bounds = b(t, "bounds", void 0)),
          (this.tracerState = L),
      ...
      onPointerDown(t) {
        if (
          ...
          switch (
            ...
            (this.pointerCamera = t.camera),
            this.tracerState)
          ) {
            case L:
              ((this.tracerState = C), this.onDrag1Start());
              break;
            case C:
              ((this.tracerState = j), this.onDrag2Start());
          }
      }
      onPointerUp(t) {
      ...
      dragCancel() {
        return (
          this.tracerState === j && this.onDrag2End(),
          (this.pointers.length = 0),
          s(this.movedState),
          (this.tracerState = L),
          this
      ...
      get distanceBetween() {
        if (this.tracerState !== j) return 0;
        var t = this.pointers[0],
          e = this.pointers[1];
        return S(t.x, t.y, e.x, e.y);
      }
      get angleBetween() {
        if (this.tracerState !== j) return 0;
        var t = this.pointers[0],
      ...
      isPointer0InGameObject(t, e, i) {
        var n = this.pointers[0];
        return !!n && x(t, n, e, i);
      }
      isPointer1InGameObject(t, e, i) {
        var n = this.pointers[1];
        return !!n && x(t, n, e, i);
      }
    }
    ...
    !(function (t) {
      ...
      function r(t, e, n, r, o) {
        ...
        return (
          t._events[a]
            ? t._events[a].fn
              ? (t._events[a] = [t._events[a], h])
              : t._events[a].push(h)
            : ((t._events[a] = h), t._eventsCount++),
          t
        );
      }
      function o(t, e) {
      ...
      (Object.create &&
        ...
        (h.prototype.emit = function (t, e, n, s, r, o) {
          var h = i ? i + t : t;
          ...
          var a,
            ...
            c = arguments.length;
          if (v.fn) {
            switch ((v.once && this.removeListener(t, v.fn, void 0, !0), c)) {
              case 1:
                return (v.fn.call(v.context), !0);
              case 2:
                return (v.fn.call(v.context, e), !0);
              case 3:
                return (v.fn.call(v.context, e, n), !0);
              case 4:
                return (v.fn.call(v.context, e, n, s), !0);
              case 5:
                return (v.fn.call(v.context, e, n, s, r), !0);
              case 6:
                return (v.fn.call(v.context, e, n, s, r, o), !0);
            }
            for (u = 1, a = new Array(c - 1); u < c; u++)
              a[u - 1] = arguments[u];
            v.fn.apply(v.context, a);
          } else {
            var p,
              d = v.length;
            for (u = 0; u < d; u++)
              switch (
                (v[u].once && this.removeListener(t, v[u].fn, void 0, !0), c)
              ) {
                case 1:
                  v[u].fn.call(v[u].context);
                  break;
                case 2:
                  v[u].fn.call(v[u].context, e);
                  break;
                case 3:
                  v[u].fn.call(v[u].context, e, n);
                  break;
                case 4:
                  v[u].fn.call(v[u].context, e, n, s);
                  break;
                default:
                  if (!a)
                    for (p = 1, a = new Array(c - 1); p < c; p++)
                      a[p - 1] = arguments[p];
                  v[u].fn.apply(v[u].context, a);
              }
          }
          return !0;
        }),
        ...
        (h.prototype.removeListener = function (t, e, n, s) {
          var r = i ? i + t : t;
          if (!this._events[r]) return this;
          if (!e) return (o(this, r), this);
          var h = this._events[r];
          if (h.fn)
            h.fn !== e ||
              (s && !h.once) ||
              (n && h.context !== n) ||
            ...
            for (var a = 0, u = [], v = h.length; a < v; a++)
              (h[a].fn !== e ||
                (s && !h[a].once) ||
                (n && h[a].context !== n)) &&
                u.push(h[a]);
    ...
    var U = {
      ...
      F = function (t, e, i, n) {
        var s = t && ("object" == typeof t || "function" == typeof t),
          r = n && ("object" == typeof n || "function" == typeof n);
        if (!s && !r) return i;
        var o = String(e);
        if (s && o in t) return t[o];
        if (r && o in n) return n[o];
        if (-1 === o.indexOf(".")) return i;
        var h = o.split(".");
        if (s) {
          var a = k(t, h, i);
          if (a.found) return a.value;
        }
        if (r) {
          var u = k(n, h, i);
          if (u.found) return u.value;
        }
        return i;
      },
      k = function (t, e, i) {
        for (var n = t, s = i, r = 0, o = e.length; r < o; r++) {
          var h = e[r];
          if (
            !n ||
        ...
        return ((X.found = !0), (X.value = s), X);
      },
      X = {};
    const Y = ["next", "exit", "enter"];
    let G = class {
      constructor(t) {
        var e = F(t, "states", void 0);
        e && this.addStates(e);
        var i = F(t, "extend", void 0);
        if (i)
          for (var n in i)
            (this.hasOwnProperty(n) && void 0 !== this[n]) || (this[n] = i[n]);
        var s = F(t, "eventEmitter", void 0),
          r = F(t, "EventEmitterClass", void 0);
      ...
      resetFromJSON(t) {
        (this.setEnable(F(t, "enable", !0)), this.start(F(t, "start", void 0)));
        var e = F(t, "init", void 0);
      ...
      runMethod(t, e, i, n, s, r) {
        ...
        if (o) {
          ...
          for (var a = new Array(h - 1), u = 1; u < h; u++)
            a[u - 1] = arguments[u];
          return o.apply(this, a);
        }
      }
    };
    Object.assign(G.prototype, U);
    var I = function (t, e, i, n, s) {
      ...
      for (var o = 0, h = r.length; o < h; o++) {
        var a = r[o];
        if (a.fn === i && a.context === n && a.once === s) return !0;
      }
      return !1;
    };
    const R = ["next", "exit", "enter", "update", "preupdate", "postupdate"];
    class J extends G {
      shutdown() {
        (this.stopUpdate(),
          this.stopPreUpdate(),
      ...
      startUpdate(t) {
        ...
        var e = t.sys.events;
        return (
          I(e, "update", this.update, this) ||
            ((this._scene = t), e.on("update", this.update, this)),
          this
        );
      }
      stopUpdate() {
      ...
      startPreUpdate(t) {
        ...
        var e = t.sys.events;
        return (
          I(e, "preupdate", this.preupdate, this) ||
      ...
      startPostUpdate(t) {
        ...
        var e = t.sys.events;
        return (
          I(e, "postupdate", this.postupdate, this) ||
    ...
    const z = t.Utils.Objects.GetValue;
    class V extends O {
      constructor(t, e) {
        super(t, e);
        var i = this,
          n = {
            states: {
              IDLE: {
                enter: function () {
                  ((i.prevDistance = void 0), (i.scaleFactor = 1));
                },
              },
              BEGIN: {},
              RECOGNIZED: {
        ...
        this.setRecongizedStateObject(new J(n));
      }
      resetFromJSON(t) {
        return (
          super.resetFromJSON(t),
          this.setDragThreshold(z(t, "threshold", 0)),
          this
        );
      }
      onDrag2Start() {
        ((this.scaleFactor = 1),
          ...
          (this.state = H),
          0 === this.dragThreshold && (this.state = Z));
      }
      onDrag2End() {
        this.state = W;
      }
    ...
    const W = "IDLE",
      H = "BEGIN",
      Z = "RECOGNIZED";
    class $ extends t.Plugins.BasePlugin {
      constructor(t) {
        super(t);
      }
      start() {
    ...
    : "function" == typeof define && define.amd
      ...
      : ((t =
          "undefined" != typeof globalThis
            ? globalThis
            : t || self).rexpinchplugin = e(t.Phaser)));
