<template>
  <div v-if="hasSelectedBlock" class="block-actions">
    <button class="action-btn" title="Rotate 90° (R)" @click="onRotate">
    ...
    <button class="action-btn" title="Flip Horizontal (H)" @click="onFlipHorizontal">
      <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M3 4h18v16H3zM10 9v6M14 9v6" />
      </svg>
      <span class="shortcut">H</span>
    </button>
    <button class="action-btn" title="Flip Vertical (V)" @click="onFlipVertical">
      <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M4 3v18h16V3zM9 10h6M9 14h6" />
      </svg>
      <span class="shortcut">V</span>
    </button>
    <button class="action-btn danger" title="Discard" @click="onDiscard">
      <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
