class AnalyticsService {
  ...
  init() {
    ...
    script.dataset.doNotTrack = String(this.getBooleanConfig('VITE_UMAMI_DO_NOT_TRACK', true))
    script.dataset.excludeSearch = String(this.getBooleanConfig('VITE_UMAMI_EXCLUDE_SEARCH', true))
    script.dataset.excludeHash = String(this.getBooleanConfig('VITE_UMAMI_EXCLUDE_HASH', true))
    script.dataset.performance = String(this.getBooleanConfig('VITE_UMAMI_TRACK_PERFORMANCE', true))
